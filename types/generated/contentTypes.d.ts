...
export interface ApiDriverDriver extends Schema.CollectionType {
  ...
  attributes: {
    ...
    carnum: Attribute.UID<'api::driver.driver', 'name'>;
    worktime: Attribute.DateTime & Attribute.Required;
...
export interface ApiHistoryOrderHistoryOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    order_state: Attribute.String;
    price: Attribute.BigInteger;
    order_start_time: Attribute.DateTime;
    order_complete_time: Attribute.DateTime;
    passenger_id: Attribute.Relation<
      'api::history-order.history-order',
      'manyToOne',
...
export interface ApiHistoryReceiveHistoryReceive extends Schema.CollectionType {
  ...
  attributes: {
    recieve_datetime: Attribute.DateTime;
    recieve_state: Attribute.String;
    driver_id: Attribute.Relation<
      'api::history-receive.history-receive',
      'manyToOne',
      'api::driver.driver'
...
export interface ApiPassengerPassenger extends Schema.CollectionType {
  ...
  attributes: {
    ...
    LineID: Attribute.UID<'api::passenger.passenger', 'name'> &
      Attribute.Required;
    address: Attribute.Text & Attribute.Required;
    history_orders: Attribute.Relation<
      'api::passenger.passenger',
      'oneToMany',
      'api::history-order.history-order'
    >;
